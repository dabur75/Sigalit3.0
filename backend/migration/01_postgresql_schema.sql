...
CREATE INDEX idx_schedule_month ON schedule(DATE_TRUNC('month', date));
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO sigalit_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO sigalit_user;
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA public TO sigalit_user;
